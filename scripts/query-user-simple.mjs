...
// Supabase 配置（从 mcp.json 获取）
const SUPABASE_URL = 'https://ejbdlxhphonydibcenrv.supabase.co';
// 注意：需要使用 Service Role Key 才能查询所有数据
const SUPABASE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVqYmRseGhwaG9ueWRpYmNlbnJ2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNDQzNDUzNiwiZXhwIjoyMDUwMDEwNTM2fQ.PoxP1YbCvvg_1WNPp4U_YRjO2hABXz-Fv2YRe7wJz6E';
